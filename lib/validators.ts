...
export const signUpFormSchema=z.object({
   ...
   path: ['confirmPassword']//we will show the above message in this field
...
export const insertCartSchema = z.object({
   ...
   userId:z.string().optional().nullable()//we are allowing users to add to cart even if they are not logged in.but during checkout they have to log in.
   })
